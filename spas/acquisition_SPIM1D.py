...
from spas.DMD_module import init_DMD, calculate_timings, setup_DMD, setup_patterns, setup_timings, _sequence_limits, _update_sequence, disconnect_DMD
...
def init(dmd_lib_version: str = '4.2') -> Tuple[Avantes, ALP4, int]:
    ...
    DMD, DMD_initial_memory = init_DMD(dmd_lib_version)
    camPar = _init_CAM()
    return DMD, DMD_initial_memory, camPar
...
def setup(spectrometer: Avantes,
    ...
    DMD_params = setup_DMD(DMD, add_illumination_time, DMD_initial_memory)

    setup_patterns(DMD=DMD, metadata=metadata, DMD_params=DMD_params, 
