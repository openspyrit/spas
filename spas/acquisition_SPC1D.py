...
"""Acquisition utility functions.
    ...
    Acquisition module is a generic module that call function in different setup (SPC1D_1arm, SPC1D_2arms, SCP1D and SPIM)
...
from spas.metadata_SPC1D import DMDParameters, MetaData, AcquisitionParameters
from spas.metadata_SPC1D import SpectrometerParameters, save_metadata, CAM, save_metadata_2arms
