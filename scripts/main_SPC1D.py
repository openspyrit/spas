...
if all_path.aborted == False:
    ...
    import numpy as np
    acquisition_params.wavelengths = np.linspace(400, 700, 768)
...
had_reco = had_reco_1D(data_folder_name, data_name, mean_NA = True, mean_NR = False, save_spectral_data = True, save_spatial_data = False)
#%% Plot
