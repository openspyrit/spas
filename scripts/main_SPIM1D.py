...
Nz                       = [6, 7, 8]# to move the stage to acquire the third spatial dimension
...
object_name              = 'fluo_µsphere-gel-bin_1' 
data_folder_name         = '2026-03-06_test_SPIM'#'Patient-69_exvivo_LGG_BU'
